...
public:
	...
	cListaAlquileres* terminarAlquileres(cFecha* fechaActual = NULL);

	#pragma region Getters
	cVehiculo* getVehiculoCategoria(string categoria, cFecha* fechaInicio = NULL, cFecha* fechaFin = NULL);
